...
[You can try it online!](https://townsquare-project.onrender.com)

If you want to learn more about how to use original app as a player, [JayBotC](https://www.youtube.com/channel/UCNZy-4Rp877XtTHaIZdWYFQ) kindly created two tutorial videos.
...
### Added Features 
- Support for co-storytelling
- Added support for in Discord communication through bot
- Full funtionality for Mobile users
- Expanded options to support running game for ST
...
* Original creator of clocktower.online by [bra1n] (https://github.com/bra1n)
This project and its website are provided free of charge and not affiliated with The Pandemonium Institute in any way.

## Donations
This project would not be possible without original creator, as such if you want to support him with a donation, you can do that here:
